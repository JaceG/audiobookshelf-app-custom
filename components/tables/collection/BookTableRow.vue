  ...
  <div class="w-full px-2 py-2 overflow-hidden relative">
    <nuxt-link v-if="book" :to="`/item/${book.id}`" class="flex items-center w-full">
      ...
      <div class="w-8 min-w-8 flex justify-center">
        <button v-if="isPlayable && showPlayBtn" class="w-8 h-8 rounded-full border border-white border-opacity-20 flex items-center justify-center" @click.stop.prevent="playClick">
