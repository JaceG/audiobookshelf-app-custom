...
export default {
  ...
  methods: {
    ...
    async fetchCategories() {
      ...
      if (isConnectedToServerWithInternet) {
        const categories = await this.$nativeHttp.get(`/api/libraries/${this.currentLibraryId}/personalized?minified=1&include=rssfeed,numEpisodesIncomplete&personalProfile=${this.isPersonalLibrary}`, { connectTimeout: 10000 }).catch((error) => {
