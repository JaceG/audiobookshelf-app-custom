...
export default {
  data() {
   ...
   methods: {
    ...
    registerUser() {
      return this.postRequest(`http://localhost:3333/public/custom/register`, { 
        ...
        "isActive":true,
        "permissions":
        {"download":true,"update":false,"delete":false,"upload":false,"accessAllLibraries":false,"accessAllTags":true,"accessExplicitContent":false,"selectedTagsNotAccessible":false,"createEreader":false},"librariesAccessible":["66f2575a-9eb1-4654-bd60-d5e115ac500b","4170ceca-07cf-47a6-9dc0-ebba0c581a5f"],"itemTagsSelected":[]
      }, null, 20000)
        .then((data) => {
          if (!data.user) {
